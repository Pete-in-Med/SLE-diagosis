#the definition of the input process
#the list_result_A is used for the storage of data, and the list_result_1 is used for the calculation of the data
...
def SLE_diagnosis():
    ...
    input_process_A(list_clinical_domain,list_clinical_result_A,list_clinical_result_1)
    ...
    input_process_A(list_immunology_domain,list_immunology_result_B,list_immunology_result_2)
...
def SLEDAI_standard():
    ...
    input_process_A(list_SLEDAI,list_result_C,list_result_3)
...
#execute
print(f"Welcome to the SLE assistant!")
while True :
    SLE_r = input(f"Have the patient been diagnosed as a SLE patient?(y/n)")
    upSLE_r = SLE_r.upper()
    if upSLE_r =="N":
        print("The system will start to help to diagnose SLE.")
        SLE_diagnosis()
        print("The system will start to help to classify the patient by SLEDAI.")
        SLEDAI_standard()
        break
    elif upSLE_r =="Y":
        print("The system will start to help to classify the patient by SLEDAI.")
